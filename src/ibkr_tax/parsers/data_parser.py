        ...
        trade_list.append(
            {
                ...
                "Realized_PnL": safe_float(lot.get("@fifoPnlRealized")),
...
def calculate_summary(
    ...
    if not trades_df.empty:
        ...
        summary["Trade_Summary"] = {
            ...
            "Realized_PnL_CNY": round(total_pnl_cny, 2),
            "Total_Commission_USD": round(total_commission, 2),
            "Total_Commission_CNY": round(total_commission_cny, 2),
            "Net_PnL_USD": round(total_pnl - total_commission, 2),
            "Net_PnL_CNY": round(total_pnl_cny - total_commission_cny, 2),
    ...
    if "Trade_Summary" in summary and "Dividend_Summary" in summary:
        taxable_income_cny = (
            summary["Trade_Summary"]["Net_PnL_CNY"]
